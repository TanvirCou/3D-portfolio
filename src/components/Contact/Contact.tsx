...
const svgVariants = {
  hidden: { opacity: 1 },
  visible: { opacity: 0, transition: { duration: 1, delay: 3 } },
};
...
const Contact = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={textVariants}
        className="flex w-[90%] items-center justify-center gap-x-8 gap-y-10 max-md:flex-col sm:w-[70%] md:w-[90%] xl:w-[82%]"
      >
        <motion.div
          variants={textVariants}
          className="flex w-full flex-col gap-y-6 text-center md:w-[40%] md:text-start"
        >
          <motion.p
            variants={textVariants}
            className="text-4xl font-semibold leading-[52px] text-white md:text-6xl"
          >
            Let&#39;s work together
          </motion.p>
          <motion.div variants={textVariants}>
            <p className="text-md leading-4 text-white">Mail</p>
          ...
          <motion.div variants={textVariants}>
            <p className="text-md text-white">Phone</p>
            <p className="text-sm">+880-1859594373</p>
          </motion.div>
        </motion.div>
        <div className="relative w-full md:w-[40%]">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="absolute z-[-1] flex w-full justify-center stroke-[#dd4c62]"
          >
            <motion.svg
              variants={svgVariants}
              width="300px"
          ...
          >
            <input
              ...
              placeholder="Name"
              className="h-9 w-full rounded-sm border border-white bg-transparent px-1.5"
            />
            <input
              type="email"
              required
            ...
            <textarea
              ...
              placeholder="Message"
              className="w-full rounded-sm border border-white bg-transparent px-1.5"
            />
            <motion.button
